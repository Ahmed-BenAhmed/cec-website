  ...
  if (filterButtons) {
    filterButtons.forEach(button => {
      button.addEventListener('click', (e) => {
        const status = (e.currentTarget as HTMLElement).dataset.status as 'all' | 'upcoming' | 'ongoing' | 'completed' | 'canceled';
...
// Example of how to connect category filter dropdown
  const categoryFilterProjects = document.getElementById('project-category-filter') as HTMLSelectElement;
...
// Example of how to connect technology filter dropdown
  const techFilterProjects = document.getElementById('project-tech-filter') as HTMLSelectElement;
...
// Example of how to connect search input
  const searchInputProjects = document.getElementById('project-search') as HTMLInputElement;
